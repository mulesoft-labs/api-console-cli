...
/** @typedef {import('../serve/Serve').ServeOptions} ServeOptions */
...
export class ServeCommand extends Command {
  ...
  constructor() {
    ...
    this.args = [
      ...
      },
      {
        ...
        alias: 'p',
        type: Number,
        description: 'The port to serve from. If not set it is assigned automatically.',
      },
      {
        name: 'hostname',
        alias: 'H',
  ...
  /**
   * Runs the command
   * @param {ServeOptions} opts Building configuration
    ...
    const sections = [
      {
        ...
        content: 'Creates an http server and serves content form the current directory.',
      },
      {
        header: 'SYNOPSIS',
        content: [
      ...
      },
      {
        ...
        content: [
          ...
          'exists in the current directory then it will be served by default. Otherwise ' +
